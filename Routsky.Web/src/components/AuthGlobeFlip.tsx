                                        ...
                                        <form onSubmit={handleLoginSubmit} className="space-y-4 w-full text-left">
                                            ...
                                            <div className="flex gap-3">
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => {
                                                        // GitHub'a direkt sabitlenmiş ID ile gidiyoruz
                                                        window.location.href = "https://github.com/login/oauth/authorize?client_id=Ov23liOViNjynBnKaJzQ&scope=user:email";
                                                    }}
                                                    ...
                                                    {/* İçerideki SVG / GitHub ikonu aynen kalsın */}
