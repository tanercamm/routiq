...
public static class DbInitializer
{
    ...
    // ─────────────────────────────────────────────
    private static async Task SeedVisaRulesAsync(RoutskyDbContext context)
    {
    ...
    private static async Task SeedSampleRouteAsync(RoutskyDbContext context, int userId)
    {
    ...
    // ─────────────────────────────────────────────
    private static async Task SeedVisaMatrixAsync(RoutskyDbContext context)
    {
